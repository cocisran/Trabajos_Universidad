...
/**
 * Clase encargada del manejo de los datasets
 */
public class Lector {
    /**
     * Metodo encargado de leer y procesar el archivo con el formato "dataset1" y
     * volcar su informacion el cache pasado por parametro
     * 
     * @param catalogo cache del programa
     */
    public static void scaner1(HashMap<String, Lugar> catalogo) {
        ...
        try {
            ...
            System.out.println("El archivo " + data1 + " fue ignorado debido a un error en su lectura");
        }

    }

    /**
     * Metodo encargado de leer y procesar el archivo con el formato "dataset2" y
     * volcar su informacion el cache pasado por parametro
     * 
     * @param catalogo cache del programa
     */
    public static void scaner2(HashMap<String, Lugar> catalogo) {
        ...
        try {
            ...
            while ((linea = in.readLine()) != null) {
                ...
                if (!ciudad.isEmpty() && catalogo.get(ciudad) == null) {
            ...
            System.out.println("El archivo " + data2 + " fue ignorado debido a un error en su lectura");
        }

    }

    /**
     * Metodo que obtiene un diccionario con el codigo IATA como clave y la ciudad
